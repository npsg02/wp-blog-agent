            ...
            <form method="post" action="<?php echo admin_url('admin-post.php'); ?>">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <?php
                            // Get posts that are generated by the agent but not in this series
                            ...
                            $available_posts = get_posts($available_posts_args);
                            ...
                            if (!empty($available_posts)) {
                                ...
                                foreach ($available_posts as $available_post) {
                                    echo '<option value="' . $available_post->ID . '">' . esc_html($available_post->post_title) . ' (' . get_the_date('', $available_post->ID) . ')</option>';
                                }
                                echo '</select>';
                            } else {
                                echo '<p>' . esc_html__('No available posts to add. All generated posts are already in this series.', 'wp-blog-agent') . '</p>';
                            }
                            ?>
                        </td>
                    </tr>
